...
class ARedisConnection extends Component  {
    ...
    /**
     * Время на ожидание коннекта, если за это время коннект не получен, то создается новый
     * @var int
     */
    public $timeout=0;
	...
	public function scan(&$it, $str_pattern = null, $i_count = null){
		return $this->getClient()->scan($it, $str_pattern, $i_count);
	}
	
	public function sScan($key, &$it, $str_pattern = null, $i_count = null){
		return $this->getClient()->sScan($key, $it, $str_pattern, $i_count);
	}
	
	public function hScan($str_key, &$i_iterator, $str_pattern = null, $i_count = null){		
		return $this->getClient()->hScan($str_key, $i_iterator, $str_pattern, $i_count);
	}

	public function zScan($key, &$it, $str_pattern = null, $i_count = null){
		return $this->getClient()->zScan($key, $it, $str_pattern, $i_count);
	}
